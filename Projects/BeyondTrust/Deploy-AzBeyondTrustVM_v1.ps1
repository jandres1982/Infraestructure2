...
$subnetName = "Infrastructure-IaaS-Subnet_1" 
...
$tenant = "aa06dce7-99d7-403b-8a08-0c5f50471e64" 
...
$vnet = Get-AzVirtualNetwork  -ResourceGroupName "RG_NETWORK_PROD" -Name $vnetname 

$subnet = Get-AzVirtualNetworkSubnetConfig -Name "Infrastructure-IaaS-Subnet_1" -VirtualNetwork $vnet 
