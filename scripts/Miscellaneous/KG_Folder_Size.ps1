...
#Clear File
write-host "" > "D:\Servers\Scripts\Schindler\KGFolderSize\Share_Folder_Size.csv"
#####
...
foreach ($i in $KGSharedFolder){
    ...
    New-Object -TypeName PSCustomObject -Property @{
        ...
        FolderName = $KG
    }| Export-Csv -Path "D:\Servers\Scripts\Schindler\KGFolderSize\Share_Folder_Size.csv" -NoTypeInformation -Append
}

add-content -path "\\shhdna0010\Reports$\KGFolderSize\KGsFolderSizeReport.csv" -value " "
(Get-Content "D:\Servers\Scripts\Schindler\KGFolderSize\Share_Folder_Size.csv" | Select-Object -Skip 1) | Add-Content "\\shhdna0010\Reports$\KGFolderSize\KGsFolderSizeReport.csv"
