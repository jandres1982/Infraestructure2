#=================================================================================#
#                                                                                 #
# 2020A_I_SWD_WSUS.ps1                                                            #
# Powershell Script to set desktop wallpaper OSD in Progress                      #
#                                                                                 #
# Author: Erich Niffeler                                                          #
# Creation Date: 24.06.2015                                                       #
# Modified Date: 24.06.2015 Erich Niffeler                                        #
# Version: 01.00.00                                                               #
#                                                                                 #
# Example: powershell.exe -executionpolicy bypass -File C:\Tools\2020A_I_SWD_WSUS\#
# 2020A_I_SWD_WSUS.ps1                                                            #
#                                                                                 #   
