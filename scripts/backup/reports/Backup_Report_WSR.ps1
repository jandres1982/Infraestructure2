...
$Jobs = Get-AzRecoveryServicesBackupJob -VaultId $Vault_ID.Id -BackupManagementType AzureVM | where-object {$_.WorkLoadname -like "*wsr*"} -WarningAction SilentlyContinue
...
$to = "antoniovicente.vento@schindler.com","alfonso.marques@schindler.com","alberto.delgado@schindler.com","fernando.camps@schindler.com"
