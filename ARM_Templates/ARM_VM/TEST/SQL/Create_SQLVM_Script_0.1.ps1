...
$parameters_base = ".\_Infraestructure\ARM_Templates\ARM_Templates\ARM_VM\TEST\SQL\parameters.json"
$template_2019 = ".\_Infraestructure\ARM_Templates\ARM_Templates\ARM_VM\TEST\SQL\template.json"
$template = ".\_Infraestructure\ARM_Templates\ARM_Templates\ARM_VM\TEST\SQL\template_2021.json"
...
$parameters | ConvertTo-Json | Out-File -FilePath ".\_Infraestructure\ARM_Templates\ARM_Templates\ARM_VM\TEST\SQL\parameters.json" -Encoding utf8 -Force
#command to create a Vm
New-AzResourceGroupDeployment -ResourceGroupName $rg -TemplateFile $template_2019 -TemplateParameterFile ".\_Infraestructure\ARM_Templates\ARM_Templates\ARM_VM\TEST\SQL\parameters.json"
