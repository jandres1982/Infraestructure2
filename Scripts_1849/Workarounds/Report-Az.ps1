...
Get-AzSubscription | Select-Object ID | foreach {$_.ID} > "D:\Repository\Working\Antonio\Azure\Report_Azure_VM\Azure_report_VM.txt"
$subs_id = gc "D:\Repository\Working\Antonio\Azure\Report_Azure_VM\Azure_report_VM.txt"
foreach ($subscriptionId in $subs_id)
{
