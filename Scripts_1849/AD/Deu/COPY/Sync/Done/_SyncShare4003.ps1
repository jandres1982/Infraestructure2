...
$To = $From,"patrick.schmurr@schindler.com"# ****** for multiple recipients, separate by commas,"patrick.schmurr@schindler.com","ernst.hameister@schindler.com","alfonso.marques@schindler.com","fernando.camps@schindler.com","david.sanchoiguaz@schindler.com","antoniovicente.vento@schindler.com","luis.javier.labodia@schindler.com"
...
robocopy  "$SourceG" "$DestinationG" /ZB /E /COPYALL /MT:100 /R:1 /W:0 /V /TEE /LOG:$LogG
...
robocopy  "$SourceP" "$DestinationP" /ZB /COPYALL /MT:100 /R:1 /W:0 /V /TEE /LOG:$LogP
