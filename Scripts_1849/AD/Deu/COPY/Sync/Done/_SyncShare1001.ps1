...
robocopy  "$SourceG" "$DestinationG" /E /MIR /ZB /COPY:DT /MT:50 /R:0 /W:0 /XD /V /TEE /LOG:$LogG
...
robocopy  "$SourceP" "$DestinationP" /E /MIR /ZB /COPY:DT /MT:50 /R:0 /W:0 /XD /V /TEE /LOG:$LogP
