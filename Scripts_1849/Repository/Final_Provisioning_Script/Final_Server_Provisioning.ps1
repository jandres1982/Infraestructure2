...
Write-Host "*           8. Install Netbackup Client (Only Swisscom VCenter)              *" -BackgroundColor DarkGray
...
Write-Host "*           23. Exit                                                         *" -BackgroundColor Black
Write-Host "*                                                                            *"
Write-Host "*                                                                            *"
...
while(($inp = Read-Host -Prompt "Select an option") -ne "23"){
