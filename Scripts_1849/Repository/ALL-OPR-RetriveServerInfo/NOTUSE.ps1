...
#>
#Get the server list
$servers = Get-Content "D:\Working\Taavean3\Retrive-Server-Info\ServerList.txt"
...
$infoColl | Export-Csv -path D:\Working\Taavean3\Retrive-Server-Info\Information_$((Get-Date).ToString('MM-dd-yyyy')).csv -NoTypeInformation #Export the results in csv file.