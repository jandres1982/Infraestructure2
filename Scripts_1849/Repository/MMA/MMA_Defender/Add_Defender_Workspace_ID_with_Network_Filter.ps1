...
function InstallNewMMA_Defender_no_Proxy
{
    New-Item -ItemType Directory -Force "c:\TEMP\Azure\MMA"
    cmd.exe /c '"C:\temp\Azure\MMASetup-AMD64.exe" /c /t:c:\TEMP\Azure\MMA'
    cmd.exe /c 'C:\TEMP\Azure\MMA\Setup.exe /qn NOAPM=1 ADD_OPINSIGHTS_WORKSPACE=1 OPINSIGHTS_WORKSPACE_AZURE_CLOUD_TYPE=0 OPINSIGHTS_WORKSPACE_ID="434c56f6-348e-429d-aede-00bb26860a0b" OPINSIGHTS_WORKSPACE_KEY="dM1GnR5cYcmnCa77mAhAxkFT+7LcMshBDWonxpY3l14UCYYVBHDpz7yc4cUHZnmMKc9JN4p/7SQqY6f5cnVOUg==" AcceptEndUserLicenseAgreement=1"'
}
...
Defender_OS2019
       ...
       switch ($version)
       {
           "NO Installed"
           {
               ...
               InstallNewMMA_Defender_no_Proxy
           }
           "Greater"
           {
