...
Write-host "Current Guest with SID 501: $Guest"
#
#
#
################################################################################################################
...
$password = Get-Content "\\$Server_Vault_glo\D$\LDSource\Packages_V2\Schindler\PW_admin\Source.txt"| ConvertTo-SecureString -key $key
