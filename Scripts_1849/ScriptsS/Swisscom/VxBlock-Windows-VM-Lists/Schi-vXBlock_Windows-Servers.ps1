...
$vms = Get-vm | Where-Object {$_.PowerState -eq "PoweredOn" -and $_.guest.OSFullName -like "*Windows*"} | select name, @{n="FolderPath"; e={$_ | Get-VMFolderPath}}, @{n="OS"; e={$_.guest.OSFullName}}, @{n="HostName"; e={$_.guest.HostName}}

#Filter out VMs based on Domain, OS, Folder
$Windows_GlobalDOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*" -and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -like "*.global*"} | select name, FolderPath, HostName, OS | sort name
$Windows_DMZ2DOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -like "*dmz*"} | select name, FolderPath, HostName, OS | sort name
$Windows_TSTDOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -like "*.tst*"} | select name, FolderPath, HostName, OS | sort name
$Windows_LegacyDOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -notlike "*.tst*" -and $_.HostName -notlike "*dmz*" -and $_.HostName -notlike "*.global*" -and $_.HostName -like "*.*.schindler.com*"} | select name, FolderPath, HostName, OS | sort name
$Windows_SchindlerDOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -notlike "*.tst*" -and $_.HostName -notlike "*dmz*" -and $_.HostName -notlike "*.global*" -and $_.HostName -notlike "*.*.schindler.com*" -and $_.HostName -like "*.schindler.com*"} | select name, FolderPath, HostName, OS | sort name
$Windows_ADROOTDOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -like "*.adroot*"} | select name, FolderPath, HostName, OS | sort name
$Windows_NODOM_NOIDM_NOCITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -notlike "*Citrix*" -and $_.FolderPath -notlike "*IM*" -and $_.HostName -notlike "*.tst*" -and $_.HostName -notlike "*dmz*" -and $_.HostName -notlike "*.global*" -and $_.HostName -notlike "*.*.schindler.com*" -and $_.HostName -notlike "*.schindler.com*"} | select name, FolderPath, HostName, OS | sort name
$Windows_Unmanaged_CITRIX = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -like "*Citrix*"} | select name, FolderPath, HostName, OS | sort name
$Windows_IM = $vms | Where-Object {$_.OS -notlike "*2003*"-and $_.FolderPath -like "*IM*"} | select name, FolderPath, HostName, OS | sort name
$Windows_ALL = $vms | Where-Object {$_.OS -notlike "*2003*"} | select name, FolderPath, HostName, OS | sort name
$Windows_2k3 = $vms | Where-Object {$_.OS -like "*2003*"} | select name, FolderPath, HostName, OS | sort name
...
$Windows_2k3_count = ($Windows_2k3 | Measure-Object).count
...
$Windows_2k3.Hostname | out-file "$ScriptRootFolder\output\98_WIN_2k3\$DateTimestamp-WIN_2k3-Count$Windows_2k3_count.txt"
