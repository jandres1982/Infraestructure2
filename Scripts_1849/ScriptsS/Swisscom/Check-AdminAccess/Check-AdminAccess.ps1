#===================================================================================#
#                                                                                   #
# Check_AdminAccess.ps1  - NOT Active yet                                           #
# Powershell Script to check Admin Access on Windows VM's SCC VxBlock               #
#                                                                                   #
...
$BCC = "Erich.Niffeler@swisscom.com","Daniel.Wuersch@swisscom.com"
