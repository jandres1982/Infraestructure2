...
$ServerList = @(gc "D:\Scripts\Schindler\Checking_Disk_Pecentage_Free\ServerList2.txt")
$Label = @(gc "D:\Scripts\Schindler\Checking_Disk_Pecentage_Free\Label2.txt")
...
echo "$Server;$Total_Size" >> D:\Scripts\Schindler\Checking_Disk_Pecentage_Free\Result\Result.txt
