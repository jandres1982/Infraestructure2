...
$log = 'c:\david\logjpndna.txt'
$source = '\\jpndna0101\JPNshare_1\shares'
...
ForEach ($folder in $folders) {
    ...
    $rights = $acl.Access | Select-Object -ExpandProperty IdentityReference

   
     
    If ($rights -notcontains "BUILTIN\Administrators")
