...
$Alarmlevel = 870
$ProductID_shhwsr0703 = '00252-70000-11484-AT233'
...
{
    if (($user.msTSManagingLS -eq $ProductID_shhwsr0703))# -or ($user.msTSManagingLS -eq $ProductID_INFW0146) -or ($user.msTSManagingLS -eq $ProductID_shhwsrcx0027))
    {
...
$Frag05 = "<h3>ProductID_SHHWSR0703 = $ProductID_SHHWSR0703</h2>"
