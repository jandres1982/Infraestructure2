...
function notified_reboot($path_first, $timeleft_first, $services_file_first)
{
...
notified_reboot $file1 $timetoboot $server_w_services_to_stop1
notified_reboot $file2 $timetoboot $server_w_services_to_stop2
notified_reboot $file3 $timetoboot $server_w_services_to_stop3
notified_reboot $file4 $timetoboot $server_w_services_to_stop4
notified_reboot $file5 $timetoboot $server_w_services_to_stop5
}
else {
Write-Host "Aborted"
}