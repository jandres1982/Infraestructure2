...
$ChartColours = @("E70000", "0A77BA", "E70000", "89CBE1")
...
Add-ReportResource "Header-VMware" ($StylePath + "\Header-vmware.png") -Used $false
   ...
   <head>
	...
	<body>
      <div id='header'>
	   ...
	   <div id='vcheck'>vCheck generated on $($ENV:Computername) on $($Date.ToLongDateString()) at $($Date.ToLongTimeString())</div>
"@
