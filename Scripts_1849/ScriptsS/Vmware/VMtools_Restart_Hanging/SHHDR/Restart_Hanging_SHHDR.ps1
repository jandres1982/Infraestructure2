...
$Path = "D:\Scripts\Schindler\Vmware\VMtools_Restart_Hanging\SHHDR\"
...
$VIServer = "vcentershhdr.global.schindler.com"
...
$vms = (get-vm $vmviews | Where-Object {$_.VMHost.Parent -notlike "DR_DMZ_Cluster" -and $_.name -notlike "tst*"}).name
