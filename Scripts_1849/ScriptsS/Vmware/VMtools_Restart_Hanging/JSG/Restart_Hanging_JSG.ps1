...
$Path = "D:\Scripts\Schindler\Vmware\VMtools_Restart_Hanging\JSG\"
$CredsFile = "$Path$AdminName-VCCreds.txt"

$FileExists = Test-Path $CredsFile

if  ($FileExists -eq $false) {
    $Cred = Get-Credential -Message "VCenterJSG Credentials" -UserName $username
...
$VIServer = "vcenterzap.global.schindler.com"
...
$vms = (get-vm $vmviews | Where-Object {$_.VMHost.Parent -like "JSG_Cluster" -and $_.name -notlike "tst*"}).name
